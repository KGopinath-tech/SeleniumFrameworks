...
public class CustomerRegistrationPage {
    ...
    public void getCustomerRegistrationMenu(){click(MENU_CUSTOMER_REGISTRATION, CLICKABLE, "Customer Registration Menu");}
    ...
    public void clickCuatomerCategory(){click(DRPDWN_CUSTOMER_CATEGORY, CLICKABLE, "Category");}
}
